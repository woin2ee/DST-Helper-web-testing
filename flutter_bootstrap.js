...
_flutter.buildConfig = {"engineRevision":"d409dcdc9b4129f5484832b013f11540080e5c8c","builds":[{"compileTarget":"dart2js","renderer":"canvaskit","mainJsPath":"main.dart.js"}]};
...
_flutter.loader.load(
    {
        serviceWorkerSettings: {
            serviceWorkerVersion: '"1335545296"',
        },
        config: userConfig,
...
function setProgress(value) {
    ...
    if (progressBar) {
        ...
        function animateProgress() {
            ...
            let step = difference / 14;
            step = step * 0.7 + (difference > 0 ? 0.1 : -0.1);
...
function createProgressBar() {
    ...
    div.insertAdjacentHTML(
        'afterbegin',
        `<div class="progress col-6" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
